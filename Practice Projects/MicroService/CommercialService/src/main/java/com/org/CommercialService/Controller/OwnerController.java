...
import com.org.CommercialService.swagger.OwnerAPI;
...
public class OwnerController implements OwnerAPI{
    ...
    @Override
    public ResponseEntity<OwnerResponseDTO> registerOwner(@Valid @RequestBody OwnerRequestDTO ownerRequestDTO) {
